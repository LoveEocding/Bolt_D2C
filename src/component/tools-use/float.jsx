...
function DivUse({styleSheet,dataAttr,styleAttr,callback,id,localDomId}) {
    ...
    const [{ isDragging }, drag,preview] = useDrag({
        item: { type: 'UseComponent.Float', id:id,isHave:true,width:styleSheet.width,height:styleSheet.height},
        collect: monitor => ({
    ...
    return <div  className="use-float" id={id} key={id}  ref={drag} onClick={callback.bind(this,{styleSheet,dataAttr,styleAttr,id})}
        style={{
