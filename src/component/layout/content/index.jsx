...
import ComponentUse from '../../tools-use/index.js'; //引入真实使用的组件
...
function Content() {
    ...
    const dragEnd = (item, monitor) => {
        ...
        let tempNode = ComponentUse[item.type];
        console.log(tempNode);
        // let originNode = document.getElementById(item.id);
    ...
    return <div className="content" id="content">
        ...
        <div className="phone_canvas" ref={drop} style={{ width: PhoneList[phoneIndex].width, height: PhoneList[phoneIndex].height,border:isOver?'1px solid #e80a0a':'1px solid #f7f7f7' }}>
            ...
            <ComponentUse.img></ComponentUse.img>
        </div>
